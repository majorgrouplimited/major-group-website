          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-600">NO:5E YASAMKENT MAHALLESI 3035 CADDESI</p>
                <p className="text-zinc-600 text-sm italic mt-1">Ankara, Turkey</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-zinc-100 rounded-full flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-zinc-600">hello@major.studio</p>
              </div>
            </div>
          </div>
        </div>
